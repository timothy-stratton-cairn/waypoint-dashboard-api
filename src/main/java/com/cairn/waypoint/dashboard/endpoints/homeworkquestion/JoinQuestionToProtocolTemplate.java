...
public class JoinQuestionToProtocolTemplate {
  ...
  public ResponseEntity<?> linkQuestionToProtocolTemplate(
      @PathVariable("protocolTemplateId") Long protocolTemplateId,
      @PathVariable("questionId") Long questionId,
      Principal principal) {
    log.info("User [{}] is linking question [{}] to protocol template [{}]", principal.getName(),
        questionId, protocolTemplateId);
