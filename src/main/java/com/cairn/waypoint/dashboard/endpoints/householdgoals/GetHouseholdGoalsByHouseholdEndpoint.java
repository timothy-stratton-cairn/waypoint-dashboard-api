...
@RestController
@Tag(name = "Goals")
public class GetHouseholdGoalsByHouseholdEndpoint {

  public static final String PATH = "/api/goals/household/{householdId}";
  private final HouseholdGoalDataService dataService;

  public GetHouseholdGoalsByHouseholdEndpoint(HouseholdGoalDataService dataService) {
