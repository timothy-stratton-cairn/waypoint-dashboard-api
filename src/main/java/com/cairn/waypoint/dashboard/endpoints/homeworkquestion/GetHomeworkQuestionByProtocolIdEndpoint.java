...
public class GetHomeworkQuestionByProtocolIdEndpoint {
    ...
    public GetHomeworkQuestionByProtocolIdEndpoint( HomeworkQuestionHelperService homeworkQuestionHelperService, HomeworkQuestionDataService homeworkQuestionDataService) {
    ...
    public ResponseEntity<?> getAllQuestionsByTemplateId(@PathVariable Long protocolId, Principal principal) {
        log.info("User [{}] is retrieving all homework of the protocol [{}]", principal.getName(), protocolId);

        List<HomeworkQuestion> questions = homeworkQuestionDataService.getHomeworkQuestionsByProtocolId(protocolId);
