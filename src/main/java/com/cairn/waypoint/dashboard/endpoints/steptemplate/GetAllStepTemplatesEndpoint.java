            ...
            .stepTemplates(
                this.stepTemplateDataService.getAllStepTemplates().stream()
                    .map(stepTemplate -> StepTemplateDto.builder()
                        ...
                        .linkedHomeworkId(stepTemplate.getStepTemplateLinkedHomeworks().stream()
                            .findFirst().isPresent() ? stepTemplate.getStepTemplateLinkedHomeworks()
                            .stream().findFirst().get().getId() : null)
